...
def main(prob,group_norm,unet):
    wandb.init(
        project="VIT",
        name="motion_vit_prob{}_group_norm{}_Unet_{}".format(prob, group_norm, unet),
        config={
            "learning_rate": 1e-4,
            "num_epochs": 20,
            "batch_size": 32,
            ...
            "kernel_size1": 20,
            "kernel_size2": 30,
            "best_model_filename": "motion_vit_prob{}_group_norm{}_Unet_{}.pth".format(prob, group_norm, unet),
