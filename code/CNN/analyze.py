...
if __name__ == "__main__":
    ...
    save_fft_map_for_an_index("imagenette", "motion_cnn_prob0.5_group_norm0_Unet_False.pth",group_norm = 0, unet=False, index=50,gaussian = False, load_model=load_model, saving_location = str(Path(__file__).parent)+"/analysis_results",models_location = str(Path(__file__).parent)+"/models")